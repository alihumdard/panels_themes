...
<script src="{{ asset('theme/vendor/sweetalert/sweetalert.min.js') }}"></script>

<!-- Data Tables -->
<!-- <script src="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"></script> -->
<!-- <script src="https://cdn.datatables.net/1.10.19/js/dataTables.bootstrap4.min.js"></script> -->

<script src="{{ asset('custom/plugins/datatables/js/jquery.dataTables.min.js') }}"></script>
<script src="{{ asset('custom/plugins/datatables/js/dataTables.bootstrap4.min.js') }}"></script>
...
<!-- Custom JS-->
{{--<script src="{{ asset('custom/user/custom.js') }}"></script>--}}

<!-- JQuery Validation Plugin -->
<script src="{{ asset('custom/plugins/validation/jquery.validate.min.js') }}"></script>
