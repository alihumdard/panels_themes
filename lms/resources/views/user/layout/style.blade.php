...
<link href="{{ asset('custom/plugins/datatables/css/jquery.dataTables.min.css') }}" rel="stylesheet" media="all">
<link href="{{ asset('custom/plugins/datatables/css/dataTables.bootstrap4.min.css') }}" rel="stylesheet" media="all">
...
<!-- Custom CSS-->
{{--<link href="{{ asset('custom/admin/custom.css') }}" rel="stylesheet" media="all">--}}
